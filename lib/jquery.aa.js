...
/***/ function(module, exports, __webpack_require__) {
	...
	_jquery2.default.fn.aa = function () {
	    ...
	    var $templates = undefined.find('[aa-render]');
	    ...
	    _definedEvents2.default.forEach(function (evtName) {
	        undefined.on(evtName, '[aa-' + evtName + ']', function (event) {
	    ...
	    $templates.each(function () {
	        var $template = (0, _jquery2.default)(undefined);
	...
	var _class = function (_EventEmitter) {
	    ...
	    _createClass(_class, [{
	        ...
	        value: function render() {
	            ...
	            templates.forEach(function (_ref) {
	                ...
	                listenDataPaths.forEach(function (path) {
	                    _jquery2.default.extend(data, api.get(path));
	                });
	
	                $el.html(mustache.render(templateHtml, data)).addClass('_rendered');
	            });
	        ...
	        value: function get() {
	            ...
	            if (path) {
	                return _jquery2.default.objectPath.get(userData, path);
	            }
