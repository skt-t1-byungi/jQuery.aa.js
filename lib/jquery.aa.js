(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("jquery.aa", ["jQuery"], factory);
	else if(typeof exports === 'object')
		exports["jquery.aa"] = factory(require("jQuery"));
	else
		root["jquery.aa"] = factory(root["jQuery"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventAttr = __webpack_require__(4);
	
	var _EventAttr2 = _interopRequireDefault(_EventAttr);
	
	var _definedEvents = __webpack_require__(5);
	...
	_jquery2.default.aa.fn = function (immediatelyRender) {
	    var _this = this;
	    ...
	    _definedEvents2.default.forEach(function (evtName) {
	        _this.on(evtName, '[aa-' + evtName + ']', function (event) {
	            ...
	            if (!parser) {
	                ...
	                parser = new _EventAttr2.default(expr, $el, emitter);
	                $el.data(parser);
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _wolfy87Eventemitter = __webpack_require__(3);
...
/***/ function(module, exports) {
	...
	var EVENT_EXPANDO = '_$EVENT_' + Date.now();
	
	var _class = function () {
	    function _class($el, expr, emitter) {
	        _classCallCheck(this, _class);
	    ...
	    _createClass(_class, [{
	        ...
	        value: function parse(expr) {
	            ...
	            return this.extractNames(expr).map(function (name) {
	                var regex = new RegExp('^s*' + name + '(([^)]*))?s*,?');
	                var matched = expr.match(regex);
	
	                var params = [];
	
	                //param 존재할경
	                if (matched.length > 1) {
	                    params = matched[1].slice(1, -1) //괄호제거
	        ...
	        key: 'extractNames',
	        value: function extractNames(expr) {
	        ...
	        value: function trigger(event) {
	            ...
	            this.parsed.forEach(function (item) {
	                var params = item.params.map(function (param) {
	                    return param === EVENT_EXPANDO ? event : param;
	                });
	                _this2.emitter.trigger(item.name, params);
	            });
	        }
	    }]);
